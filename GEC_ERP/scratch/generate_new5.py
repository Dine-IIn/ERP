...
# ==============================================================================
# 1. GENERATE new5_Item_Master_Generated.xlsx & new5_items_template.csv
# ==============================================================================
...
for it_key, it in sorted(items_dict.items(), key=lambda x: (x[1]['category'], x[1]['name'])):
    ...
    item_code_gen = pcode if pcode else f"ITEM-{item_idx_counter:06d}"
    item_idx_counter += 1
...
wb_item.save('data/item_master/new5_Item_Master_Generated.xlsx')
pd.DataFrame(csv_item_rows[1:], columns=csv_item_rows[0]).to_csv('data/item_master/new5_items_template.csv', index=False, encoding='utf-8')
print("Generated data/item_master/new5_Item_Master_Generated.xlsx & new5_items_template.csv")

# ==============================================================================
# 2. GENERATE new5_Process_Master_Generated.xlsx & new5_processes_template.csv
# ==============================================================================
...
wb_proc.save('data/process_master/new5_Process_Master_Generated.xlsx')
pd.DataFrame(csv_proc_rows[1:], columns=csv_proc_rows[0]).to_csv('data/process_master/new5_processes_template.csv', index=False, encoding='utf-8')
print("Generated data/process_master/new5_Process_Master_Generated.xlsx & new5_processes_template.csv")

# ==============================================================================
# 3. GENERATE new5_BOM_Master_Generated.xlsx & new5_boms_template.csv
# ==============================================================================
...
bom_headers = [
    ...
    "BOM Qty Per Machine", "Unit", "Lead Time in Days", "Scrap %", "Estimated Assembly Hours"
]
...
wb_bom.save('data/bom/new5_BOM_Master_Generated.xlsx')
pd.DataFrame(csv_bom_rows[1:], columns=csv_bom_rows[0]).to_csv('data/bom/new5_boms_template.csv', index=False, encoding='utf-8')
print("Generated data/bom/new5_BOM_Master_Generated.xlsx & new5_boms_template.csv")

# ==============================================================================
# 4. GENERATE new5_Inventory_Master_Generated.xlsx & new5_inventory_template.csv
# ==============================================================================
...
inv_headers = [
    ...
    "Min Safety Stock Qty", "Min Order Qty", "Lead Time in Days", "Warehouse Location",
...
for it_key, it in sorted(items_dict.items(), key=lambda x: (x[1]['category'], x[1]['name'])):
    ...
    asset_val = tot * price
    qc = it['qc_trigger']
    item_code_gen = pcode if pcode else f"ITEM-{item_inv_counter:06d}"
    item_inv_counter += 1
...
wb_inv.save('data/inventory/new5_Inventory_Master_Generated.xlsx')
pd.DataFrame(csv_inv_rows[1:], columns=csv_inv_rows[0]).to_csv('data/inventory/new5_inventory_template.csv', index=False, encoding='utf-8')
print("Generated data/inventory/new5_Inventory_Master_Generated.xlsx & new5_inventory_template.csv")

print("\n============================================================")
print("[SUCCESS] All 4 new5_... master sheets & CSV templates generated cleanly!")
print("============================================================")
