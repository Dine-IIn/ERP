export const MASTER_FEATURES_HIERARCHY = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'WHATSAPP_SHARE_LINK', name: 'Document Sharing Integration (Manual)', desc: 'Open prefilled message link in WhatsApp Web/App or trigger generic share options' },
      { key: 'WHATSAPP_LINKED_DEVICE', name: 'Automated Dispatch Integration (QR Scan)', desc: 'Connect device via QR & dispatch templates automatically in background' }
    ]
  },
  {
    key: 'MASTER_DATA',
