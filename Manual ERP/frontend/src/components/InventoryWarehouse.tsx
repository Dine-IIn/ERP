  ...
  return (
    <div className="max-w-4xl mx-auto select-none animate-fade-in">
      ...
      <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-8 text-center flex flex-col items-center justify-center">
        ...
        <h4 className="text-lg font-bold text-[var(--text-primary)] mb-2 font-display">Welcome to Inventory & Warehouse Management</h4>
        <p className="text-[var(--text-secondary)] text-sm max-w-md mx-auto">
          Manage your stock levels, warehouse locations, and inventory movements. This module is currently active but waiting for data populations. Please configure the sub-features from the super admin panel.
        </p>
      </div>
    </div>
  );
