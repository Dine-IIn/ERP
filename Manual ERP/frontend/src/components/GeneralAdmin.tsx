...
export default function GeneralAdmin({
  ...
  return (
    <div className="max-w-6xl mx-auto select-none animate-fade-in text-left">
      ...
      <div className="flex border-b border-[var(--border-color)] mb-6 gap-2 text-xs overflow-x-auto select-none py-1 scrollbar-none">
        <button
          onClick={() => setActiveTab('profile')}
          className={`py-2 px-4 rounded-xl font-bold flex items-center gap-2 transition-all cursor-pointer ${
            activeTab === 'profile'
              ? 'bg-indigo-500/10 text-indigo-400 border-b-2 border-indigo-500'
              : 'text-[var(--text-secondary)] hover:bg-[var(--bg-tertiary)]'
          }`}
        >
          <Building className="w-3.5 h-3.5" /> Profile Settings & Wizard
        </button>
        ...
        >
          <DollarSign className="w-3.5 h-3.5" /> GST & Taxes
        </button>
        ...
        >
          <Sliders className="w-3.5 h-3.5" /> Multi-Currency
        </button>
        ...
        >
          <Workflow className="w-3.5 h-3.5" /> Workflow Approvals
        </button>
        ...
        >
          <Bell className="w-3.5 h-3.5" /> Notifications Live
        </button>
        ...
        >
          <FileText className="w-3.5 h-3.5" /> DMS Drive
        </button>
        ...
        >
          <Mail className="w-3.5 h-3.5" /> Email Integration
        </button>
        ...
        >
          <GitMerge className="w-3.5 h-3.5" /> Org & Hierarchy
        </button>
        ...
        >
          <Database className="w-3.5 h-3.5" /> SQLite Backup
        </button>
        ...
        {user.isSuperAdmin && (
          ...
          >
            <Sliders className="w-3.5 h-3.5" /> Feature Toggles ({companyFeatures.length})
          </button>
        )}
      </div>
