...
const HumanResources: React.FC<Props> = ({ user, activeTab }) => {
    const mapping: any = {'HR_DASHBOARD': 'dashboard', 'HR_PROFILES': 'employees', 'HR_ATTENDANCE': 'attendance', 'HR_LEAVE': 'leave', 'HR_PAYROLL': 'payroll', 'HR_SALARY_SLIPS': 'slips', 'HR_REIMBURSEMENTS': 'reimbursements', 'HR_RECRUITMENT': 'recruitment', 'HR_SHIFT': 'shifts', 'HR_PERFORMANCE': 'performance', 'HR_REPORTS': 'reports', 'HR_DOCUMENTS': 'documents'};
