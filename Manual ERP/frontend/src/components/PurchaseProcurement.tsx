...
const PurchaseProcurement: React.FC<Props> = ({ user, activeTab }) => {
    const mapping: any = {'PURCHASE_VENDOR_MGT': 'vendors', 'PURCHASE_REQUISITIONS': 'requisitions', 'PURCHASE_ORDERS': 'orders', 'PURCHASE_QUOTATIONS': 'quotations', 'PURCHASE_COMPARISON': 'comparison', 'PURCHASE_PAYMENTS': 'payments', 'PURCHASE_APPROVALS': 'approvals', 'PURCHASE_REPORTS': 'reports'};
  const currentTab = (activeTab && mapping[activeTab]) ? mapping[activeTab] : 'vendors';
