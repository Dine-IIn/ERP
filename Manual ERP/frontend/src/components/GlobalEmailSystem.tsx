...
const GlobalEmailSystem: React.FC<Props> = ({ user, activeTab }) => {
    const mapping: any = {'EMAIL_SMTP': 'smtp', 'EMAIL_TEMPLATES': 'templates', 'EMAIL_QUEUE': 'queue', 'EMAIL_LOGS': 'logs'};
  const currentTab = (activeTab && mapping[activeTab]) ? mapping[activeTab] : 'smtp';
