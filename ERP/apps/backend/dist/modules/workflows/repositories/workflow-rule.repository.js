...
exports.WorkflowRuleRepository = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const workflow_rule_entity_1 = require("../entities/workflow-rule.entity");
let WorkflowRuleRepository = class WorkflowRuleRepository {
    repository;
...
exports.WorkflowRuleRepository = WorkflowRuleRepository;
exports.WorkflowRuleRepository = WorkflowRuleRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(workflow_rule_entity_1.WorkflowRule)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], WorkflowRuleRepository);
//# sourceMappingURL=workflow-rule.repository.js.map